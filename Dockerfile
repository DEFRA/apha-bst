...
# Build the app
RUN dotnet build "Apha.BST/Apha.BST.Web/Apha.BST.Web.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Publish the app
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "Apha.BST/Apha.BST.Web/Apha.BST.Web.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
