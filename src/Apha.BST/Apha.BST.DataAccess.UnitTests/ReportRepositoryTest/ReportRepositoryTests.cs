...
namespace Apha.BST.DataAccess.UnitTests.ReportRepositoryTest
{
    public class ReportRepositoryTests
    {
        ...
        public async Task GetAphaReportsAsync_ReturnsReports()
        {
            ...
            var repo = new TestReportRepository(mockContext.Object, aphaReports: reports);
        ...
        public async Task GetPeopleReportsAsync_ReturnsReports()
        {
            ...
            var mockContext = new Mock<BstContext>();
            var repo = new TestReportRepository(mockContext.Object, peopleReports: reports);
        ...
        public async Task GetSiteReportsAsync_ReturnsReports()
        {
            ...
            var mockContext = new Mock<BstContext>();
            var repo = new TestReportRepository(mockContext.Object, siteReports: reports);
        ...
        public async Task GetTrainerReportsAsync_ReturnsReports()
        {
            ...
            var mockContext = new Mock<BstContext>();
            var repo = new TestReportRepository(mockContext.Object, trainerReports: reports);
        ...
        public async Task GetTrainingReportsAsync_ReturnsReports()
        {
            ...
            var mockContext = new Mock<BstContext>();
            var repo = new TestReportRepository(mockContext.Object, trainingReports: reports);
