...
namespace Apha.BST.Application.UnitTests.PersonServiceTest
{
    public class AbstractPersonServiceTest
    {
        ...
        //public void MockForGetPersons()
        //{
        //    var persons = new List<Persons>
        //    {
        //        new Persons { PersonId = 1, Person = "John Doe" },
        //        new Persons { PersonId = 2, Person = "Jane Smith" }
        //    };

        //    var mockRepo = Substitute.For<IPersonsRepository>();
        //    mockRepo.GetAllAsync().Returns(Task.FromResult(persons.AsEnumerable()));
        ...
        //            .ForMember(dest => dest.VlalocationId, opt => opt.MapFrom(src => src.VlalocationId));
        //    });
        ...
        {
            var personDetails = new List<PersonDetails>
            {
                new PersonDetails { PersonID = personId, Person = "John Doe", PlantNo = "PLANT001", Name = "Test Site" }
            };
            ...
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<PersonDetails, PersonDetailsDto>();
            });
